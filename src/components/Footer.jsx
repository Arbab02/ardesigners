...
const Footer = () => {
  return (
    <footer className="bg-[#0D0214] text-white border-t-[1px] py-10">
      <div className="container mx-auto px-6 sm:px-8 md:px-12 lg:px-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <div>
          ...
          <p>
            We are a leading garments factory providing high-quality products
        ...
        <div>
          ...
          <p className="mb-2">Email: info@garmentsfactory.com</p>
      ...
      <div className="container mx-auto px-6 sm:px-8 md:px-12 lg:px-16 text-center mt-8">
        <p>&copy; 2024 Garments Factory. All rights reserved.</p>
      </div>
    </footer>
  );
};

...
const AboutUs = () => {
  ...
  return (
    <div className="bg-[#0D0214] text-white py-16">
      <div className="container mx-auto px-6 sm:px-8 md:px-12 lg:px-16">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-center max-w-3xl mx-auto">
            Our mission is to provide high-quality garments tailored to meet
            the unique needs of our customers. We aim to deliver excellence
